  ...
  return (
    <>
      <div className={props.className}>
        ...
        <div className="absolute bottom-[2%] flex flex-col left-[4%] w-[88%] md:w-full">
          <div className="flex sm:flex-col flex-row gap-1.5 items-center justify-between mx-auto w-full">
            <Text
              className="capitalize font-helvetica text-pink_400"
              as="h4"
              variant="h4"
            >
              {props?.dispatchunitmotOne}
            </Text>
            <Line className="bg-pink_400 h-0.5 mb-[15px] sm:mt-0 mt-3 w-3/4" />
          </div>
          <Img
            src="images/img_table3png.png"
            className="h-[226px] ml-5 mt-[-1.31px] object-cover w-[23%] z-[1]"
            alt="table3png"
          />
        </div>
        <Button
...
export default CBMDispatchunit;
